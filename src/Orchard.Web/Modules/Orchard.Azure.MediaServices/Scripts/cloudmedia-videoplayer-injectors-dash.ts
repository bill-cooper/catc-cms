...
module Orchard.Azure.MediaServices.VideoPlayer.Injectors {
    ...
    export class DashInjector extends Injector {
        ...
        public isSupported(): boolean {
            ...
            //this is just a hack to get the typescript to compile
            //because I don't have 1.4 version of type script.
            //this should be overwritten by the orchard version
            //on next merge.
            var hasMse = true;//MediaSource && MediaSource.isTypeSupported && MediaSource.isTypeSupported("video/mp4; codecs=\"avc1.4d404f\"");
