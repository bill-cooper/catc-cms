...
namespace ceenq.com.Layouts.Controllers
{
    public class AdminController : Controller, IUpdateModel
    {
        ...
        public ActionResult CreatePOST(CreateTypeViewModel viewModel)
        {
            ...
            //also add autoroute and layout parts
            _contentDefinitionService.AddPartToType("AutoroutePart", viewModel.Name);
            _contentDefinitionService.AddPartToType("LayoutPart", viewModel.Name);
        ...
        public ActionResult AddFieldToPOST(AddFieldViewModel viewModel, string id)
        {
            ...
            try
            {
                ...
                //try to add the same field to the layout part

                if (partViewModel.Name != "Layout")
                {
                    var layoutPartViewModel = _contentDefinitionService.GetPart("Layout");
                    if (layoutPartViewModel != null)
                    {
                        _contentDefinitionService.AddFieldToPart(viewModel.Name, viewModel.DisplayName, viewModel.FieldTypeName, layoutPartViewModel.Name);
                    }
                }
